...
- `MeloMD-3.0.0-mac-arm64.dmg`：Apple Silicon Mac 安装包。
- `MeloMD-3.0.0-mac-arm64.zip`：Apple Silicon macOS 应用压缩包。
- `MeloMD-3.0.0-mac-x64.dmg`：Intel Mac 安装包。
- `MeloMD-3.0.0-mac-x64.zip`：Intel macOS 应用压缩包。
- `MeloMD-3.0.0-win-x64.exe`：64 位 Windows 安装包。
- `MeloMD-3.0.0-win-x64.zip`：64 位 Windows 便携压缩包。
